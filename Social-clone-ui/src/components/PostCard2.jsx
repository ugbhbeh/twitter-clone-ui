...
export default function PostCard2({ post, onLike, onDislike}) {
      ...
      <div className="flex items-center space-x-4 mt-4 pt-4 border-t border-accent/10">
        ...
        <button
          ...
          className={`flex items-center space-x-2 transition-colors ${
            post.likedByUser ? "text-primary" : "text-accent hover:text-primary"
          }`}
        >
        ...
        <button
          ...
          className={`flex items-center space-x-2 transition-colors ${
            post.dislikedByUser ? "text-primary" : "text-accent hover:text-primary"
          }`}
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
